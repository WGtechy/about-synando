...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    <h2>Privacy Policy</h2>
        <h4> INTRODUCTION TO PRIVACY POLICY AND REGULATIONS</h4>
        <p>
          {" "}
          Synando LLC, a Texas Limited Liability Company (“Company”, “us”, “we”,
          or “our”) operates the Synando LLC website (the "Site") and mobile
          applications (the “applications”). This page informs you of our
        ...
        <p>
          ...
          not limited to your name, date of birth, location, etc. ("Personal
          Information").
        </p>
...
<p>This Privacy Policy is effective as of January 31, 2022, and will remain in effect except with respect
